...
export default function PersonCard({ name, role, photoUrl, githubUrl, onClick }: PersonCardProps) {
  return (
    <div className=" hover:-translate-y-1">
      <Border title={name}>
        <div className="flex items-center gap-x-3.5 m-2 sm:m-5 cursor-pointer font-serif" onClick={onClick}>
          <div className="overflow-hidden w-24 sm:h-24 rounded-[50%] min-[320px]:h-20 min-[320px]:w-20">
