...
export default function NotFound() {
  return (
    <div className='flex flex-col items-center justify-end w-full font-serif h-96'>
      ...
      <Link href="/" className='cursor-pointer leading-none px-3 py-1 border border-solid border-transparent rounded  bg-emerald-900 text-white text-xl'>Return Home</Link>
    </div>
  )
}